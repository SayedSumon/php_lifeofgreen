...
if (isset($_POST['add_blog'])) {
    ...
    if ($select->rowCount() > 0) {
        ...
        $insert = $conn->prepare("INSERT INTO `blog`(advisor_name, title, description, category, image) VALUES(?,?,?,?,?)");
            $insert->execute([$name, $title, $description, $category, $image]);
...
<body>
    ...
    <section class="add-blog">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="inputBox">
                <span>Name :</span>
                <input type="text" name="name" value="admin" placeholder="admin" class="box">
                <span>Title :</span>
