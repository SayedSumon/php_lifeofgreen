...
<body>
   ...
   <section class="product">
      ...
      <div class="box-containers">
         ...
         <?php
         $season_name = $_GET['seasonal'];
         $select_products = $conn->prepare("SELECT * FROM `products` WHERE season = ?");
         $select_products->execute([$season_name]);
