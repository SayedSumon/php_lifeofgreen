...
<body>
    ...
    <section class="">
        ...
        <div class="blog-container">
            <div class="blogs">
                ...
                $select_blogs = $conn->prepare("SELECT * FROM `blog` WHERE category = ? LIMIT {$offset}, {$limit}");
                ...
                <?php
                    ...
                    echo '<p class="empty">no blog in this category!</p>';
                }
                ?>
            </div>
    ...
    <?php
   $select_blogs = $conn->prepare("SELECT * FROM `blog` WHERE category = ?");
   $select_blogs->execute([$category_name]);
   ...
   if ($page_number > 1) {
      echo '<li><a href="category_blog.php?category='.$category_name.'&page=' . ($page_number - 1) . '"><i class="fa-solid fa-chevron-left"></i></a></li>';
   }
   ...
   for ($i = 1; $i <= $total_page; $i++) {
      ...
      echo '<li class=' . $active . '><a href="category_blog.php?category='.$category_name.'&page=' . $i . '">' . $i . '</a></li>';
   }

   if ($total_page > $page_number) {
      echo '<li><a href="category_blog.php?category='.$category_name.'&page=' . ($page_number + 1) . '"><i class="fa-solid fa-chevron-right"></i></a></li>';
   }
