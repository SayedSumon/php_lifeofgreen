...
if (isset($_POST['send'])) {
   ...
   $user_id = $_POST['id'];
   $user_id = filter_var($id, FILTER_SANITIZE_STRING);
   $msg = $_POST['msg'];
   ...
   if ($select_message->rowCount() > 0) {
      ...
      $insert_message = $conn->prepare("INSERT INTO `message`(message) VALUES(?)");
      $insert_message->execute([$msg]);
         ...
         ?>
               <div class="box">
                  ...
                  <form action="" method="POST">
                     <input type="hidden" name="id" class="box" value="<?= $fetch_message['user_id']; ?>">
